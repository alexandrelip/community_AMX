...
local failed_left = get_param_handle("AMX_FAIL_HYD_L")
local failed_right = get_param_handle("AMX_FAIL_HYD_R")
...
function update()
	...
	local left_pump = engine_rpm > 53 and failed_left:get() < 0.5
	local right_pump = engine_rpm > 53 and failed_right:get() < 0.5
	...
	P_HYD1_L = math.max(0, math.min(206, P_HYD1_L))
	L_HYD1:set(P_HYD1_L < 100 and 1 or 0)
	...
	P_HYD2_L = math.max(0, math.min(206, P_HYD2_L))
	L_HYD2:set(P_HYD2_L < 100 and 1 or 0)
