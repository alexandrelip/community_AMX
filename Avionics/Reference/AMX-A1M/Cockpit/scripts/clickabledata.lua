...
elements["PNT_912"] = multiposition_switch_limited(_("Flaps, UP/MID/DOWN"), devices.COMMANDS, device_commands.Button_9, 59, 3, 0.5)
elements["PNT_912"].action[2] = device_commands.Button_10
...
elements["PTR-ARM-LAND-GEAR-084"] = default_2_position_tumb(_("Landing Gear, DOWN/UP"), devices.COMMANDS, device_commands.Button_4, 6)
elements["PTR-ARM-LAND-GEAR-084"].action[2] = device_commands.Button_5
elements["PTR-ARM-LAND-GEAR-084"].cycle = false
...
elements["PTR-ALM-T-GENEG"]	= default_2_position_tumb(_("Generator 1"), devices.ELECTRIC_SYSTEM, device_commands.Button_12, 290)
elements["PTR-ALM-T-GENED"]	= default_2_position_tumb(_("Generator 2"), devices.ELECTRIC_SYSTEM, device_commands.Button_13, 291)
...
elements["PTR-START-LENG"]	= default_3_position_tumb(_("Engine Starter, START/OFF/STOP"), devices.START_PANEL, device_commands.Button_20, 296)
elements["PTR-START-LENG"].class = {class_type.BTN, class_type.BTN}
elements["PTR-START-LENG"].stop_action = {device_commands.Button_20, device_commands.Button_20}
elements["PTR-START-LENG"].use_release_message = {true, true}
elements["PTR-START-LENG"].cycle = false
...
elements["PTR-START-LFUELCUT"]	= default_2_position_tumb(_("Engine Fuel Shutoff, SHUT/OPEN"), devices.START_PANEL, device_commands.Button_26, 309)
