...
local m1_config = dofile(LockOn_Options.script_path .. "../../Config/AMX_EDM_BINDINGS.lua")
if m1_config.enabled == true then
	shape_name = assert(m1_config.model.shape_name)
end
...
local amx_exterior = dofile(LockOn_Options.script_path .. "../../Config/AMX_EXTERNAL_MODEL.lua")
amx_exterior.mainpanel(_G)
...
Landinggearhandle.arg_number		= 6
...
FLAPSWITCH.parameter_name = "AMX_FLAPS_HANDLE"
FLAPSWITCH.arg_number = 59
FLAPSWITCH.input = {0, 1}
FLAPSWITCH.output = {0, 1}

SMS_POWER_SWITCH = CreateGauge("parameter")
SMS_POWER_SWITCH.parameter_name = "AMX_SMS_SWITCH"
SMS_POWER_SWITCH.arg_number = 1844
SMS_POWER_SWITCH.input = {0, 1}
SMS_POWER_SWITCH.output = {0, 1}

AVIONICS_MASTER_SWITCH = CreateGauge("parameter")
AVIONICS_MASTER_SWITCH.parameter_name = "AMX_AVIONICS_SWITCH"
AVIONICS_MASTER_SWITCH.arg_number = 1843
AVIONICS_MASTER_SWITCH.input = {0, 1}
AVIONICS_MASTER_SWITCH.output = {0, 1}
