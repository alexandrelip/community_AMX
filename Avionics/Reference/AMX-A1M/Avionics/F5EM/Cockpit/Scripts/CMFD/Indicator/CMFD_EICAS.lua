...
default_stroke_thickness  = 1 --0.25
default_stroke_fuzziness  = 0.6
...
-- default_element_params={"CMFD"..CMFDNu.."Format"}
-- default_controllers={{"parameter_compare_with_number",0,SUB_PAGE_ID.EICAS}}
...
function addRpmScale(name, pos, parent, controllers)
    ...
    object = addStrokeText(nil, "50", CMFD_STRINGDEFS_DEF_X08, "RightCenter", {0.16, 0}, base_range.name, {{name}}, {"%3.0f"}, CMFD_FONT_DEF)
    object.element_params = {name, "CMFD"..tostring(CMFDNu).."_BRIGHT"}
    object.controllers = {{"text_using_parameter", 0}, {"opacity_using_parameter", 1}}
    ...
    object.element_params = {name .. "_POS", "A"}
    object.controllers = {{"rotate_using_parameter", 0, math.rad(-1)}}

    object = addStrokeText(nil, "50", CMFD_STRINGDEFS_DEF_X08, "RightCenter", {0.16, 0}, base_range.name, {{name}}, {"%3.0f"}, CMFD_FONT_Y)
    object.element_params = {name, "CMFD"..tostring(CMFDNu).."_BRIGHT"}
    object.controllers = {{"text_using_parameter", 0}, {"opacity_using_parameter", 1}}
    ...
    object = addStrokeText(nil, "50", CMFD_STRINGDEFS_DEF_X08, "RightCenter", {0.16, 0}, base_range.name, {{name}}, {"%3.0f"}, CMFD_FONT_K)
    object.element_params = {name, "CMFD"..tostring(CMFDNu).."_BRIGHT"}
    object.controllers = {{"text_using_parameter", 0}, {"opacity_using_parameter", 1}}
...
function addTempScale(name, pos, parent, controllers)
  ...
  object.element_params = {name .. "_POS"}
  object.controllers = {{"rotate_using_parameter", 0, math.rad(-1)}}
  object = addStrokeText(nil, "50", CMFD_STRINGDEFS_DEF_X08, "RightCenter", {0.16, 0}, base_range.name, {{name}}, {"%3.0f"}, CMFD_FONT_W)
  object.element_params = {name, "CMFD"..tostring(CMFDNu).."_BRIGHT"}
  object.controllers = {{"text_using_parameter", 0}, {"opacity_using_parameter", 1}}
  ...
  object.element_params = {name .. "_POS"}
  object.controllers = {{"rotate_using_parameter", 0, math.rad(-1)}}
  object = addStrokeText(nil, "50", CMFD_STRINGDEFS_DEF_X08, "RightCenter", {0.16, 0}, base_range.name, {{name}}, {"%3.0f"}, CMFD_FONT_G)
  object.element_params = {name, "CMFD"..tostring(CMFDNu).."_BRIGHT"}
  object.controllers = {{"text_using_parameter", 0}, {"opacity_using_parameter", 1}}
...
function addLinearNeedle(name,pos, parent, material, side)
  ...
  local base = addPlaceholder(nil,{0,0}, parent)
  local needle		= CreateElement "ceMeshPoly"
	setSymbolCommonProperties(needle, name, pos, base.name, controllers, material)
...
function addLinearScale(name, pos, parent, length, start, stop, big_ticks, small_ticks, material)
  ...
  stroke_fuzziness  = 1
  local base = addPlaceholder(nil, {0,0}, parent)
  object = addStrokeLine(nil, length * (stop - start), {0+pos[1],length * start + pos[2]}, nil, base.name, controllers, nil, nil, nil, material)
  stroke_thickness  = default_stroke_thickness
  stroke_fuzziness = default_stroke_fuzziness
...
function addPressScale(name, pos, parent, side)
  ...
  object.element_params = {name .. "_POS"}
  object.controllers = {{"move_up_down_using_parameter", 0, 0.021}}
  object = addFillBox(nil, 0.10, 0.06, "CenterCenter", {0, -0.05}, base_range.name, nil, CMFD_MATERIAL_RED)
  object = addStrokeText(nil, "50", CMFD_STRINGDEFS_DEF_X08, "CenterCenter", {0, -0.05}, base_range.name, nil, {"%.0f"}, CMFD_FONT_K)
  object.element_params = {name, "CMFD"..tostring(CMFDNu).."_BRIGHT"}
  object.controllers = {{"text_using_parameter", 0}, {"opacity_using_parameter", 1}}
  ...
  object = addStrokeText(nil, "50", CMFD_STRINGDEFS_DEF_X08, "CenterCenter", {0, -0.05}, base_range.name, nil, {"%.0f"}, CMFD_FONT_Y)
  object.element_params = {name, "CMFD"..tostring(CMFDNu).."_BRIGHT"}
  object.controllers = {{"text_using_parameter", 0}, {"opacity_using_parameter", 1}}
  ...
  object.element_params = {name .. "_POS"}
  object.controllers = {{"move_up_down_using_parameter", 0, 0.021}}
  object = addStrokeText(nil, "50", CMFD_STRINGDEFS_DEF_X08, "CenterCenter", {0, -0.05}, base_range.name, nil, {"%.0f"}, CMFD_FONT_DEF)
  object.element_params = {name, "CMFD"..tostring(CMFDNu).."_BRIGHT"}
  object.controllers = {{"text_using_parameter", 0}, {"opacity_using_parameter", 1}}
...
function addFuelScale(name, pos, parent, controllers)
  ...
  object = addStrokeText(nil, "TOTAL", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {0, -0.107}, base.name, nil, nil, CMFD_FONT_W)
  object.level             = DEFAULT_LEVEL - 1
  object.h_clip_relation = h_clip_relations.REWRITE_LEVEL
  object = addStrokeText(nil, "INTR", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {-0.0935, -0.23}, base.name, nil, nil, CMFD_FONT_W)
  object.level             = DEFAULT_LEVEL - 1
  object.h_clip_relation = h_clip_relations.REWRITE_LEVEL
  object = addStrokeText(nil, "CNTR", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {-0.0935, -0.35}, base.name, nil, nil, CMFD_FONT_W)
  object.level             = DEFAULT_LEVEL - 1
  object.h_clip_relation = h_clip_relations.REWRITE_LEVEL
  object = addStrokeText(nil, "INBD", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {-0.0935, -0.47}, base.name, nil, nil, CMFD_FONT_W)
  object.level             = DEFAULT_LEVEL - 1
  object.h_clip_relation = h_clip_relations.REWRITE_LEVEL

  object = addStrokeText(nil, "0000", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {0.0935, -0.35}, base.name, nil, {"%04.0f"}, CMFD_FONT_CYAN)
  object.element_params = {"EICAS_FUEL_CNTR", "CMFD"..tostring(CMFDNu).."_BRIGHT"}
  object.controllers = {{"text_using_parameter", 0}, {"opacity_using_parameter", 1}}
  object.level             = DEFAULT_LEVEL - 1
  object.h_clip_relation = h_clip_relations.REWRITE_LEVEL
  object = addStrokeText(nil, "0000", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {0.0935, -0.47}, base.name, nil, {"%04.0f"}, CMFD_FONT_CYAN)
  object.element_params = {"EICAS_FUEL_INBD", "CMFD"..tostring(CMFDNu).."_BRIGHT"}
  object.controllers = {{"text_using_parameter", 0}, {"opacity_using_parameter", 1}}
  object.level             = DEFAULT_LEVEL - 1
  object.h_clip_relation = h_clip_relations.REWRITE_LEVEL
  ...
  object.element_params = {name .. "_COLOR", "CMFD"..tostring(CMFDNu).."_BRIGHT"}
  object.controllers = {{"parameter_compare_with_number", 0, 0}, {"opacity_using_parameter", 1}}
  object.level             = DEFAULT_LEVEL - 1
  object.h_clip_relation = h_clip_relations.REWRITE_LEVEL
  object = addStrokeText(nil, "0000", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {0.0935, -0.23}, base.name, nil, {"%04.0f"}, CMFD_FONT_K)
  object.element_params = {name .. "_INTR", name .. "_INTR", "CMFD"..tostring(CMFDNu).."_BRIGHT"}
  object.controllers = {{"text_using_parameter", 0}, {"parameter_in_range", 1, -0.1, 800}, {"opacity_using_parameter", 2}}
  object.level             = DEFAULT_LEVEL - 1
  object.h_clip_relation = h_clip_relations.REWRITE_LEVEL

  object = addStrokeText(nil, "0000", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {0.0935, -0.23}, base.name, nil, {"%04.0f"}, CMFD_FONT_CYAN)
  object.element_params = {name .. "_INTR", name .. "_INTR", "CMFD"..tostring(CMFDNu).."_BRIGHT"}
  object.controllers = {{"text_using_parameter", 0}, {"parameter_in_range", 1, 800, 10000}, {"opacity_using_parameter", 2}}
  object.level             = DEFAULT_LEVEL - 1
  object.h_clip_relation = h_clip_relations.REWRITE_LEVEL
  ...
  object.level             = DEFAULT_LEVEL - 1
  object.h_clip_relation = h_clip_relations.REWRITE_LEVEL
  object = addStrokeText(nil, "00000", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {0, 0.03}, base.name, nil, {"%05.0f"}, CMFD_FONT_K)
  object.element_params = {name, name .. "_COLOR", "CMFD"..tostring(CMFDNu).."_BRIGHT"}
  object.controllers = {{"text_using_parameter", 0}, {"parameter_compare_with_number", 1, 0}, {"opacity_using_parameter", 2}}
  object.level             = DEFAULT_LEVEL - 1
  object.h_clip_relation = h_clip_relations.REWRITE_LEVEL

  object = addStrokeText(nil, "00000", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {0, 0.03}, base.name, nil, {"%05.0f"}, CMFD_FONT_CYAN)
  object.element_params = {name, name .. "_COLOR", "CMFD"..tostring(CMFDNu).."_BRIGHT"}
  object.controllers = {{"text_using_parameter", 0}, {"parameter_compare_with_number", 1, 1}, {"opacity_using_parameter", 2}}
  object.level             = DEFAULT_LEVEL - 1
  object.h_clip_relation = h_clip_relations.REWRITE_LEVEL

  object = addStrokeText(nil, "00000", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {0, 0.03}, base.name, nil, {"%05.0f"}, CMFD_FONT_DEF)
  object.element_params = {name, name .. "_COLOR", "CMFD"..tostring(CMFDNu).."_BRIGHT"}
  object.controllers = {{"text_using_parameter", 0}, {"parameter_compare_with_number", 1, 2}, {"opacity_using_parameter", 2}}
  object.level             = DEFAULT_LEVEL - 1
  object.h_clip_relation = h_clip_relations.REWRITE_LEVEL
...
object = addStrokeLine(nil, 1.5, {0, -0.3}, 0, page_root.name, nil, nil, nil, nil, CMFD_MATERIAL_CYAN)
object = addStrokeLine(nil, 2, {-1, -0.3}, -90, page_root.name, nil, nil, nil, nil, CMFD_MATERIAL_WHITE)
object = addStrokeLine(nil, 1, {0, 0.015}, 90, page_root.name, nil, nil, nil, nil, CMFD_MATERIAL_CYAN)
object = addStrokeLine(nil, 1, {0, 0.688}, -90, page_root.name, nil, nil, nil, nil, CMFD_MATERIAL_CYAN)
object = addStrokeLine(nil, 0.6, {0.5, 0.688}, 0, page_root.name, nil, nil, nil, nil, CMFD_MATERIAL_CYAN)

object = addRpmScale("EICAS_E1_ROT", {-0.705,0.987}, nil, nil)
object = addRpmScale("EICAS_E2_ROT", {-0.202,0.987}, nil, nil)
object = addStrokeText(nil, "R\nP\nM", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {-0.453, 0.987}, nil, nil, nil, CMFD_FONT_W)

object = addTempScale("EICAS_E1_TEMP", {-0.705,0.567}, nil, nil)
object = addTempScale("EICAS_E2_TEMP", {-0.202,0.567}, nil, nil)
object = addStrokeText(nil, "E\nG\nT\n\nC`", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {-0.453, 0.567}, nil, nil, nil, CMFD_FONT_W)

object = addStrokeText(nil, "N\nZ\n%", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {-0.453, 0.198}, nil, nil, nil, CMFD_FONT_W)
object = addStrokeSymbol(nil, {"f5em_stroke_symbols", "nz-scale"}, "CenterCenter", {-0.705, 0.12}, nil, nil, 1/1000, CMFD_MATERIAL_WHITE)
object = addStrokeText(nil, "OPEN", CMFD_STRINGDEFS_DEF_X08, "CenterCenter", {-0.75, 0.250}, nil, nil, nil, CMFD_FONT_W)
object = addStrokeText(nil, "50", CMFD_STRINGDEFS_DEF_X08, "RightCenter", {-0.545, 0.250}, nil, nil, {"%3.0f"}, CMFD_FONT_G)
...
object = addStrokeSymbol(nil, {"f5em_stroke_symbols", "nz-scale"}, "CenterCenter", {-0.202, 0.12}, nil, nil, 1/1000, CMFD_MATERIAL_WHITE)
object = addStrokeText(nil, "OPEN", CMFD_STRINGDEFS_DEF_X08, "CenterCenter", {-0.252, 0.250}, nil, nil, nil, CMFD_FONT_W)
object = addStrokeText(nil, "50", CMFD_STRINGDEFS_DEF_X08, "RightCenter", {-0.072, 0.250}, nil, nil, {"%3.0f"}, CMFD_FONT_G)
object.element_params = {default_element_params, "EICAS_E2_NOZZLE"}
object.controllers = {  default_controllers[1], {"text_using_parameter", 1, 0}}

object = addStrokeText(nil, "F/F", CMFD_STRINGDEFS_DEF_X08, "CenterCenter", {-0.453, -0.084}, nil, nil, nil, CMFD_FONT_W)
object = addStrokeText(nil, "PPH", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {-0.453, -0.167}, nil, nil, nil, CMFD_FONT_W)
object = addStrokeText(nil, "0000", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {-0.750, -0.123}, nil, nil, {"%5.0f"}, CMFD_FONT_CYAN)
object.element_params = {"EICAS_E1_FF", "CMFD"..tostring(CMFDNu).."_BRIGHT"}
object.controllers = {{"text_using_parameter", 0}, {"opacity_using_parameter", 1}}
object = addStrokeBox(nil, 0.275, 0.1, "CenterCenter", {0, 0}, object.name, nil, CMFD_MATERIAL_CYAN)

object = addStrokeText(nil, "0000", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {-0.160, -0.123}, nil, nil, {"%5.0f"}, CMFD_FONT_CYAN)
object.element_params = {"EICAS_E2_FF", "CMFD"..tostring(CMFDNu).."_BRIGHT"}
object.controllers = {{"text_using_parameter", 0}, {"opacity_using_parameter", 1}}
object = addStrokeBox(nil, 0.275, 0.1, "CenterCenter", {0, 0}, object.name, nil, CMFD_MATERIAL_CYAN)


object = addStrokeText(nil, "OIL PRESS", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {0.237, 1.194}, nil, nil, nil, CMFD_FONT_W)
object = addStrokeText(nil,  "L    R", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {0.237, 1.127}, nil, nil, nil, CMFD_FONT_W)

object = addStrokeText(nil, "HYD PRESS", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {0.713, 1.194}, nil, nil, nil, CMFD_FONT_W)
object = addStrokeText(nil, "UTIL FLT", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {0.713, 1.127}, nil, nil, nil, CMFD_FONT_W)


addFuelScale("EICAS_FUEL", {0.4155, 0.350}, page_root.name, nil)


object = addPressScale("EICAS_E1_OIL_PRES", {0.148, 0.824}, page_root.name, 1)
object = addPressScale("EICAS_E2_OIL_PRES", {0.331, 0.824}, page_root.name, -1)

object = addHydScale("EICAS_HYD_UTIL", {0.597, 0.824}, page_root.name, 1)
object = addHydScale("EICAS_HYD_FLT", {0.788, 0.824}, page_root.name, -1)


local error_base = addPlaceholder(nil, {0,0})
error_base.element_params = {"CMFD"..CMFDNu.."FULL"}
error_base.controllers = {{"parameter_compare_with_number",0,1}}

function error_label(text, i, j, mat, font)
    error_x = (i - 3) * 0.4
    error_y = -j * 0.8 / 7 - 0.26

    local base = addPlaceholder(nil, {error_x, error_y}, error_base.name)
    base.element_params = {"EICAS_ERROR_" .. text:gsub(" ","_"):gsub("-","_")}
    base.controllers = {{"parameter_compare_with_number", 0, 0}}
    object = addStrokeBox(nil, 0.35, 0.08, "CenterCenter", {0, 0}, base.name, nil, CMFD_MATERIAL_WHITE)

    base = addPlaceholder(nil, {error_x, error_y}, error_base.name)
    base.element_params = {"EICAS_ERROR_" .. text:gsub(" ","_")}
    base.controllers = {{"parameter_compare_with_number", 0, 2}}
    object = addStrokeBox(nil, 0.35, 0.08, "CenterCenter", {0, 0}, base.name, nil, mat)
    object = addStrokeText(nil, text, CMFD_STRINGDEFS_DEF_X08, "CenterCenter", {0, 0}, base.name, nil, nil, font)

    base = addPlaceholder(nil, {error_x, error_y}, error_base.name)
    base.element_params = {"EICAS_ERROR_" .. text:gsub(" ","_"):gsub("-","_")}
    base.controllers = {{"parameter_compare_with_number", 0, 1}}
    object = addFillBox(nil, 0.35, 0.08, "CenterCenter", {0, 0}, base.name, nil, mat)
    object = addStrokeText(nil, text, CMFD_STRINGDEFS_DEF_X08, "CenterCenter", {0, 0}, base.name, nil, nil, CMFD_FONT_K)

end

-- error_label("MST CAUTION",1,1,CMFD_MATERIAL_RED, CMFD_FONT_R)

error_label("LEFT ENG",   2,1,CMFD_MATERIAL_RED, CMFD_FONT_R)
error_label("CANOPY",     3,1,CMFD_MATERIAL_RED, CMFD_FONT_R)
error_label("RIGHT ENG",  4,1,CMFD_MATERIAL_RED, CMFD_FONT_R)
error_label("BALANCE",    5,1,CMFD_MATERIAL_YELLOW, CMFD_FONT_Y)

error_label("LEFT OIL",   2,2,CMFD_MATERIAL_RED, CMFD_FONT_R)
error_label("AVIONICS",   3,2,CMFD_MATERIAL_YELLOW, CMFD_FONT_Y)
error_label("RIGHT OIL",  4,2,CMFD_MATERIAL_RED, CMFD_FONT_R)
error_label("FUEL XFER",  5,2,CMFD_MATERIAL_YELLOW, CMFD_FONT_Y)

error_label("LEFT GEN",   2,3,CMFD_MATERIAL_YELLOW, CMFD_FONT_Y)
error_label("TRU FAIL",   3,3,CMFD_MATERIAL_YELLOW, CMFD_FONT_Y)
error_label("RIGHT GEN",  4,3,CMFD_MATERIAL_YELLOW, CMFD_FONT_Y)
error_label("ANTI-ICE",   5,3,CMFD_MATERIAL_CYAN, CMFD_FONT_CYAN)

error_label("UTIL HYD",   2,4,CMFD_MATERIAL_YELLOW, CMFD_FONT_Y)
error_label("BAT TEMP",   3,4,CMFD_MATERIAL_YELLOW, CMFD_FONT_Y)
error_label("FLT HYD",    4,4,CMFD_MATERIAL_YELLOW, CMFD_FONT_Y)
error_label("DVR_END",    5,4,CMFD_MATERIAL_CYAN, CMFD_FONT_CYAN)

error_label("FWD OXY",    1,5,CMFD_MATERIAL_YELLOW, CMFD_FONT_Y)
error_label("OXYGEN",     2,5,CMFD_MATERIAL_YELLOW, CMFD_FONT_Y)
error_label("T OF CNFG",  3,5,CMFD_MATERIAL_YELLOW, CMFD_FONT_Y)
error_label("EXT TANKS",  4,5,CMFD_MATERIAL_YELLOW, CMFD_FONT_Y)
error_label("DVR 10 MN",  5,5,CMFD_MATERIAL_CYAN, CMFD_FONT_CYAN)

error_label("AFT OXY",    1,6,CMFD_MATERIAL_YELLOW, CMFD_FONT_Y)
error_label("L FUEL LO",  2,6,CMFD_MATERIAL_YELLOW, CMFD_FONT_Y)
error_label("DADC",       3,6,CMFD_MATERIAL_YELLOW, CMFD_FONT_Y)
error_label("R FUEL LO",  4,6,CMFD_MATERIAL_YELLOW, CMFD_FONT_Y)
error_label("OXYBIT",     5,6,CMFD_MATERIAL_CYAN, CMFD_FONT_CYAN)

error_label("OXYFLOW",    1,7,CMFD_MATERIAL_YELLOW, CMFD_FONT_Y)
error_label("LEFT F-P",   2,7,CMFD_MATERIAL_YELLOW, CMFD_FONT_Y)
error_label("SEAT PIN",   3,7,CMFD_MATERIAL_YELLOW, CMFD_FONT_Y)
error_label("RIGHT F-P",  4,7,CMFD_MATERIAL_YELLOW, CMFD_FONT_Y)


---------------------------------------------------

local function addSmallScreen(parent)
    save_default_parent = default_parent
    default_parent = parent

    object = addStrokeText(nil, "RPM\n%", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {0,0.3}, nil, nil, nil, CMFD_FONT_W)
    object = addStrokeText(nil, "EGT", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {0,0.15}, nil, nil, nil, CMFD_FONT_W)
    object = addStrokeText(nil, "NZ %", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {0,0}, nil, nil, nil, CMFD_FONT_W)
    object = addStrokeText(nil, "F/F\nPPH", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {0,-0.15}, nil, nil, nil, CMFD_FONT_W)
    object = addStrokeText(nil, "OIL\nPRESS", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {0,-0.3}, nil, nil, nil, CMFD_FONT_W)
    object = addStrokeLine(nil, 1, {-0.5, 0.225}, -90, nil, nil, nil, nil, nil, CMFD_MATERIAL_CYAN)
    object = addStrokeLine(nil, 1, {-0.5, 0.075}, -90, nil, nil, nil, nil, nil, CMFD_MATERIAL_CYAN)
    object = addStrokeLine(nil, 1, {-0.5, -0.075}, -90, nil, nil, nil, nil, nil, CMFD_MATERIAL_CYAN)
    object = addStrokeLine(nil, 1, {-0.5, -0.225}, -90, nil, nil, nil, nil, nil, CMFD_MATERIAL_CYAN)
    ...
    -- Eng Rotation
    object = addFillBox(nil, 0.275, 0.1, "CenterCenter", {-0.25, 0.3}, nil, nil, CMFD_MATERIAL_RED)
    object.element_params = {default_element_params, "EICAS_E1_ROT_COLOR"}
    object.controllers = {default_controllers[1], {"parameter_in_range", 1, 1.5, 3.5}}
    object.additive_alpha = false
    object = addStrokeBox(nil, 0.275, 0.1, "CenterCenter", {-0.25, 0.3}, nil, nil, CMFD_MATERIAL_YELLOW)
    object.element_params = {default_element_params, "EICAS_E1_ROT_COLOR"}
    object.controllers = {default_controllers[1], {"parameter_compare_with_number", 1, 1}}
    object.additive_alpha = false
    object = addStrokeText(nil, "50", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {-0.25, 0.3}, nil, nil, {"%3.0f"}, CMFD_FONT_DEF)
    object.element_params = {default_element_params, "EICAS_E1_ROT", "EICAS_E1_ROT_COLOR"}
    object.controllers = {  default_controllers[1], {"text_using_parameter", 1, 0},
                            {"change_color_when_parameter_equal_to_number", 2, 1, 1,1,0},
                            {"change_color_when_parameter_equal_to_number", 2, 2, 0,0,0},
                            {"change_color_when_parameter_equal_to_number", 2, 3, 0,0,0},
                          }
    object.additive_alpha = false

    object = addFillBox(nil, 0.275, 0.1, "CenterCenter", {0.25, 0.3}, nil, nil, CMFD_MATERIAL_RED)
    object.element_params = {default_element_params, "EICAS_E2_ROT_COLOR"}
    object.controllers = {default_controllers[1], {"parameter_in_range", 1, 1.5, 3.5}}
    object.additive_alpha = false
    object = addStrokeBox(nil, 0.275, 0.1, "CenterCenter", {0.25, 0.3}, nil, nil, CMFD_MATERIAL_YELLOW)
    object.element_params = {default_element_params, "EICAS_E2_ROT_COLOR"}
    ...
    object.additive_alpha = false
    object = addStrokeText(nil, "50", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {0.25, 0.3}, nil, nil, {"%3.0f"}, CMFD_FONT_DEF)
    object.element_params = {default_element_params, "EICAS_E2_ROT", "EICAS_E2_ROT_COLOR"}
    object.controllers = {  default_controllers[1], {"text_using_parameter", 1, 0},
                            {"change_color_when_parameter_equal_to_number", 2, 1, 1,1,0},
                            {"change_color_when_parameter_equal_to_number", 2, 2, 0,0,0},
                            {"change_color_when_parameter_equal_to_number", 2, 3, 0,0,0},
    ...
    object = addFillBox(nil, 0.275, 0.1, "CenterCenter", {-0.25, 0.15}, nil, nil, CMFD_MATERIAL_RED)
    object.element_params = {default_element_params, "EICAS_E1_TEMP_COLOR"}
    object.controllers = {default_controllers[1], {"parameter_compare_with_number", 1, 3}}
    object.additive_alpha = false
    object = addStrokeBox(nil, 0.275, 0.1, "CenterCenter", {-0.25, 0.15}, nil, nil, CMFD_MATERIAL_YELLOW)
    object.element_params = {default_element_params, "EICAS_E1_TEMP_COLOR"}
    object.controllers = {default_controllers[1], {"parameter_compare_with_number", 1, 2}}
    object.additive_alpha = false

    object = addStrokeText(nil, "50", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {-0.25, 0.15}, nil, nil, {"%3.0f"}, CMFD_FONT_DEF)
    object.element_params = {default_element_params, "EICAS_E1_TEMP", "EICAS_E1_TEMP_COLOR"}
    object.controllers = {  default_controllers[1], {"text_using_parameter", 1, 0},
    ...
    object = addFillBox(nil, 0.275, 0.1, "CenterCenter", {0.25, 0.15}, nil, nil, CMFD_MATERIAL_RED)
    object.element_params = {default_element_params, "EICAS_E2_TEMP_COLOR"}
    object.controllers = {default_controllers[1], {"parameter_compare_with_number", 1, 3}}
    object.additive_alpha = false
    object = addStrokeBox(nil, 0.275, 0.1, "CenterCenter", {0.25, 0.15}, nil, nil, CMFD_MATERIAL_YELLOW)
    object.element_params = {default_element_params, "EICAS_E2_TEMP_COLOR"}
    ...
    object = addStrokeText(nil, "50", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {0.25, 0.15}, nil, nil, {"%3.0f"}, CMFD_FONT_DEF)
    object.element_params = {default_element_params, "EICAS_E2_TEMP", "EICAS_E2_TEMP_COLOR"}
    object.controllers = {  default_controllers[1], {"text_using_parameter", 1, 0},
                            {"change_color_when_parameter_equal_to_number", 2, 0, 1,1,1},
                            {"change_color_when_parameter_equal_to_number", 2, 2, 1,1,0},
                            {"change_color_when_parameter_equal_to_number", 2, 3, 0,0,0},
    ...
    -- Nozzle
    object = addStrokeText(nil, " 00", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {-0.25, 0.0}, nil, nil, {"%3.0f"}, CMFD_FONT_DEF)
    object.element_params = {default_element_params, "EICAS_E1_NOZZLE"}
    object.controllers = {  default_controllers[1], {"text_using_parameter", 1, 0}}
    object = addStrokeText(nil, " 00", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {0.25, 0.0}, nil, nil, {"%3.0f"}, CMFD_FONT_DEF)
    object.element_params = {default_element_params, "EICAS_E2_NOZZLE"}
    ...
    -- Fuel Flow
    object = addStrokeText(nil, " 0000", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {-0.25, -0.15}, nil, nil, {"%5.0f"}, CMFD_FONT_CYAN)
    object.element_params = {default_element_params, "EICAS_E1_FF"}
    object.controllers = {  default_controllers[1], {"text_using_parameter", 1, 0}}
    object = addStrokeBox(nil, 0.275, 0.1, "CenterCenter", {0, 0}, object.name, nil, CMFD_MATERIAL_CYAN)
    object = addStrokeText(nil, " 0000", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {0.25, -0.15}, nil, nil, {"%5.0f"}, CMFD_FONT_CYAN)
    object.element_params = {default_element_params, "EICAS_E2_FF"}
    object.controllers = {  default_controllers[1], {"text_using_parameter", 1, 0}}
    object = addStrokeBox(nil, 0.275, 0.1, "CenterCenter", {0, 0}, object.name, nil, CMFD_MATERIAL_CYAN)
    ...
    -- Oil Pressure
    object = addFillBox(nil, 0.275, 0.1, "CenterCenter", {-0.25, -0.3}, nil, nil, CMFD_MATERIAL_RED)
    object.element_params = {default_element_params, "EICAS_E1_OIL_PRES_COLOR"}
    ...
    object.additive_alpha = false
    object = addStrokeText(nil, "50", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {-0.25, -0.3}, nil, nil, {"%3.0f"}, CMFD_FONT_DEF)
    object.element_params = {default_element_params, "EICAS_E1_OIL_PRES", "EICAS_E1_OIL_PRES_COLOR"}
    object.controllers = {  default_controllers[1], {"text_using_parameter", 1, 0},
    ...
    object = addFillBox(nil, 0.275, 0.1, "CenterCenter", {0.25, -0.3}, nil, nil, CMFD_MATERIAL_RED)
    object.element_params = {default_element_params, "EICAS_E2_OIL_PRES_COLOR"}
    object.controllers = {default_controllers[1], {"parameter_compare_with_number", 1, 0}}
    object.additive_alpha = false
    object = addFillBox(nil, 0.275, 0.1, "CenterCenter", {0.25, -0.3}, nil, nil, CMFD_MATERIAL_RED)
    object.element_params = {default_element_params, "EICAS_E2_OIL_PRES_COLOR"}
    ...
    object.additive_alpha = false
    object = addStrokeText(nil, "50", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {0.25, -0.3}, nil, nil, {"%3.0f"}, CMFD_FONT_DEF)
    object.element_params = {default_element_params, "EICAS_E2_OIL_PRES", "EICAS_E2_OIL_PRES_COLOR"}
    object.controllers = {  default_controllers[1], {"text_using_parameter", 1, 0},
                            {"change_color_when_parameter_equal_to_number", 2, 0, 0,0,0},
                            {"change_color_when_parameter_equal_to_number", 2, 1, 1,1,0},
                            {"change_color_when_parameter_equal_to_number", 2, 3, 0,0,0},
