...
-- [PFL] Fault list body -- multi-line string published by CMFD/Device/pfl.lua
-- as PFL_TEXT. Empty string = no active faults (page blank, matches real jet).
-- The list is already sorted priority-first and ack-filtered by pfl_check.lua.
local pfl_body          = CreateElement "ceStringPoly"
pfl_body.material       = CMFD_FONT_DEF
pfl_body.stringdefs     = CMFD_STRINGDEFS_DEF_X08
pfl_body.init_pos       = {-0.40, 0.45}
pfl_body.alignment      = "LeftCenter"
pfl_body.value          = ""
pfl_body.formats        = {"%s"}
pfl_body.element_params = {"CMFD"..tostring(CMFDNu).."_BRIGHT", "PFL_TEXT"}
pfl_body.controllers    = {{"opacity_using_parameter", 0}, {"text_using_parameter", 1, 0}}
pfl_body.parent_element = page_root.name
AddElementObject(pfl_body)
pfl_body = nil
