...
-- BUGFIX: page_root was gated on SUB_PAGE_ID.DTE which does not exist in
-- CMFD_pageID_defs.lua (only SUB_PAGE_ID.DTU). With nil the compare was
-- unreachable and the whole DTU page rendered EMPTY. dtu.lua registers on
-- SUB_PAGE_ID.DTU (see its L708) and publishes CMFD_DTE_TEXT / CMFD_DTE_FORMAT
-- (kept as-is: those are DATA namespaces, unrelated to the page ID).
page_root.controllers = {{"parameter_compare_with_number",0,SUB_PAGE_ID.DTU}}
