...
page_subsets = {
    ...
    [SUB_PAGE_ID.RDR         ] = cmfd_page_path .. "CMFD_RDR.lua",
    [SUB_PAGE_ID.LDP         ] = cmfd_page_path .. "CMFD_LDP.lua",
    ...
    [SUB_PAGE_ID.EMER        ] = cmfd_page_path .. "CMFD_EMER.lua",
    [SUB_PAGE_ID.DTU         ] = cmfd_page_path .. "CMFD_DTU.lua",
    [SUB_PAGE_ID.UFC         ] = cmfd_page_path .. "CMFD_UFC.lua",
    [SUB_PAGE_ID.HUD         ] = cmfd_page_path .. "CMFD_HUD.lua",
    [SUB_PAGE_ID.HMD         ] = cmfd_page_path .. "CMFD_HMD.lua",
    ...
    [SUB_PAGE_ID.IFR         ] = cmfd_page_path .. "CMFD_IFR.lua",
    [SUB_PAGE_ID.TSD         ] = cmfd_page_path .. "CMFD_TSD.lua",
    [SUB_PAGE_ID.LT          ] = cmfd_page_path .. "CMFD_LT.lua",
    [SUB_PAGE_ID.MAP         ] = cmfd_page_path .. "CMFD_MAP.lua",
    [SUB_PAGE_ID.DLSET       ] = cmfd_page_path .. "CMFD_DLSET.lua",
    [SUB_PAGE_ID.DLMSG       ] = cmfd_page_path .. "CMFD_DLMSG.lua",
    [SUB_PAGE_ID.EFB         ] = cmfd_page_path .. "CMFD_EFB.lua",
    [SUB_PAGE_ID.SURV        ] = cmfd_page_path .. "CMFD_SURV.lua",
    [SUB_PAGE_ID.ADHSI_SMALL ] = cmfd_page_path .. "CMFD_ADHSI_small.lua",
...
mat_tbl = {
    ...
    -- FLIR IR video render target (fed by the LR::ccCamera FLIR indicator).
    -- Engine-provided slot used by the A-29 LR::ccCamera FLIR pipeline.
    "render_target_1",
}
