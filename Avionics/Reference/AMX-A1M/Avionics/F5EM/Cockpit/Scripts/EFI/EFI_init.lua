...
SUB_PAGE_NAME[SUB_PAGE_ID.EFI]    = "EFI"
...
local cmfd_page_path = LockOn_Options.script_path .. "EFI/Indicator/"

page_subsets = {
    [SUB_PAGE_ID.BASE        ] = cmfd_page_path .. "FULL_BASE.lua",
    [SUB_PAGE_ID.OFF         ] = cmfd_page_path .. "EFI_OFF.lua",
    [SUB_PAGE_ID.NOAUX       ] = cmfd_page_path .. "EFI_NOAUX.lua",
    [SUB_PAGE_ID.EFI         ] = cmfd_page_path .. "EFI.lua",
}
...
function EFI_set_screenspace_displacement(aspect, left_center_right, zoom_value)
...
try_find_assigned_viewport("F5EM_EFI")
