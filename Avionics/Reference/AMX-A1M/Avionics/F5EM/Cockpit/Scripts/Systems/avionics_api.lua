...
AVIONICS_MASTER_MODE_STR[3] = "INT S"
AVIONICS_MASTER_MODE_STR[4] = "INT M"
AVIONICS_MASTER_MODE_STR[5] = "DGFT S"
AVIONICS_MASTER_MODE_STR[6] = "DGFT M"
...
function get_avionics_master_mode_aa(master_mode)
    ...
    return  master_mode == AVIONICS_MASTER_MODE_ID.DGFT_S or
        master_mode == AVIONICS_MASTER_MODE_ID.DGFT_M or
        master_mode == AVIONICS_MASTER_MODE_ID.INT_S or 
        master_mode == AVIONICS_MASTER_MODE_ID.INT_M
end

function get_avionics_master_mode_aa_int(master_mode)
    master_mode = master_mode or get_avionics_master_mode()
    return  master_mode == AVIONICS_MASTER_MODE_ID.INT_S or 
        master_mode == AVIONICS_MASTER_MODE_ID.INT_M
end
...
function get_avionics_master_mode_aa_dgft(master_mode)
    master_mode = master_mode or get_avionics_master_mode()
    return  master_mode == AVIONICS_MASTER_MODE_ID.DGFT_S or
    master_mode == AVIONICS_MASTER_MODE_ID.DGFT_M
end
