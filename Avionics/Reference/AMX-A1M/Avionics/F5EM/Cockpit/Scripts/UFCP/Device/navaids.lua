...
local NAVAIDS = {
    ON = get_param_handle("UFCP_NAVAIDS_ON"),
    ILS_FREQ = get_param_handle("UFCP_NAVAIDS_ILS_FREQ"),
    VOR_FREQ = get_param_handle("UFCP_NAVAIDS_VOR_FREQ"),
    ADF_FREQ = get_param_handle("UFCP_NAVAIDS_ADF_FREQ"),
    ADF_NEXT_FREQ = get_param_handle("UFCP_NAVAIDS_ADF_NEXT_FREQ"),
    ADF_MODE = get_param_handle("UFCP_NAVAIDS_ADF_MODE"),
    HOLD = get_param_handle("UFCP_NAVAIDS_HOLD"),
    VOR_HOLD_FREQ = get_param_handle("UFCP_NAVAIDS_VOR_HOLD_FREQ"),
}
...
local function sync_navaids_params()
    NAVAIDS.ON:set(ufcp_navaids_on and 1 or 0)
    NAVAIDS.ILS_FREQ:set(ufcp_navaids_ils)
    NAVAIDS.VOR_FREQ:set(ufcp_navaids_vor)
    NAVAIDS.ADF_FREQ:set(ufcp_navaids_adf)
    NAVAIDS.ADF_NEXT_FREQ:set(ufcp_navaids_adf_next)
    NAVAIDS.ADF_MODE:set(ufcp_navaids_adf_mode)
    NAVAIDS.HOLD:set(ufcp_navaids_hold and 1 or 0)
    NAVAIDS.VOR_HOLD_FREQ:set(ufcp_navaids_vor_hold)
...
function update_nav_aids()
    ...
    ufcp_navaids_crs = ADHSI_COURSE:get()
