...
function SetCommandMode(command,value)
    ...
    elseif command == device_commands.UFCP_0 and value == 1 then
        if sel == 0 then
            ...
            if slv_src == WPN_AA_SLV_SRC_IDS.S then 
                set_avionics_master_mode(AVIONICS_MASTER_MODE_ID.INT_S)
            else
                set_avionics_master_mode(AVIONICS_MASTER_MODE_ID.INT_M)
            end
        elseif sel == 1 then
        ...
        elseif sel == 3 then
            ...
            if slv_src == WPN_AA_SLV_SRC_IDS.S then 
                ...
                set_avionics_master_mode(AVIONICS_MASTER_MODE_ID.DGFT_M)
            end
        end
    end
end