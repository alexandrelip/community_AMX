...
update_time_step = 0.05 -- UFCP host: 20 Hz
...
local function ufcp_on()
    return get_elec_essential_dc_bus_ok() and get_cockpit_draw_argument_value(1480) > 0 and get_cockpit_draw_argument_value(1843) > 0
end
...
dofile(LockOn_Options.script_path.."UFCP/Device/main.lua")
dofile(LockOn_Options.script_path.."UFCP/Device/ufcp_com1.lua")
dofile(LockOn_Options.script_path.."UFCP/Device/ufcp_com2.lua")
dofile(LockOn_Options.script_path.."UFCP/Device/navaids.lua")
dofile(LockOn_Options.script_path.."UFCP/Device/vvvah.lua")
dofile(LockOn_Options.script_path.."UFCP/Device/dah.lua")
dofile(LockOn_Options.script_path.."UFCP/Device/wpt.lua")
dofile(LockOn_Options.script_path.."UFCP/Device/xpdr.lua")
dofile(LockOn_Options.script_path.."UFCP/Device/time.lua")
dofile(LockOn_Options.script_path.."UFCP/Device/mark.lua")
dofile(LockOn_Options.script_path.."UFCP/Device/fix.lua")
dofile(LockOn_Options.script_path.."UFCP/Device/tip.lua")
dofile(LockOn_Options.script_path.."UFCP/Device/menu.lua")
dofile(LockOn_Options.script_path.."UFCP/Device/lmt.lua")
dofile(LockOn_Options.script_path.."UFCP/Device/dtk.lua")
dofile(LockOn_Options.script_path.."UFCP/Device/bal.lua")
dofile(LockOn_Options.script_path.."UFCP/Device/acal.lua")
dofile(LockOn_Options.script_path.."UFCP/Device/nav.lua")
dofile(LockOn_Options.script_path.."UFCP/Device/ws.lua")
dofile(LockOn_Options.script_path.."UFCP/Device/egi.lua")
dofile(LockOn_Options.script_path.."UFCP/Device/fuel.lua")
dofile(LockOn_Options.script_path.."UFCP/Device/tac.lua")
dofile(LockOn_Options.script_path.."UFCP/Device/mode.lua")
dofile(LockOn_Options.script_path.."UFCP/Device/oap.lua")
dofile(LockOn_Options.script_path.."UFCP/Device/cf.lua")
dofile(LockOn_Options.script_path.."UFCP/Device/para.lua")
dofile(LockOn_Options.script_path.."UFCP/Device/fti.lua")
dofile(LockOn_Options.script_path.."UFCP/Device/dclt.lua")
dofile(LockOn_Options.script_path.."UFCP/Device/crus.lua")
dofile(LockOn_Options.script_path.."UFCP/Device/drft.lua")
dofile(LockOn_Options.script_path.."UFCP/Device/tkl.lua")
dofile(LockOn_Options.script_path.."UFCP/Device/strm.lua")
dofile(LockOn_Options.script_path.."UFCP/Device/flir.lua")
dofile(LockOn_Options.script_path.."UFCP/Device/dl.lua")
dofile(LockOn_Options.script_path.."UFCP/Device/manr.lua")


function update()
    local ufcp_bright = get_cockpit_draw_argument_value(1480)
    update_egir()
    update_xpdr_dtc()
    update_xpdr_state()
    update_com1_dtc()
    ...
    if get_elec_main_dc_bus_ok() then 
    ...
    if get_elec_essential_dc_bus_ok() then
    ...
    elseif ufcp_sel_format == UFCP_FORMAT_IDS.MANR then update_manr()
    end
...
function post_initialize()
    ...
    if birth=="GROUND_HOT" or birth=="AIR_HOT" then
        dev:performClickableAction(device_commands.UFCP_XPDR_POWER, 1, true)
    ...
    elseif birth=="GROUND_COLD" then
        dev:performClickableAction(device_commands.UFCP_XPDR_POWER, 0, true)
        dev:performClickableAction(device_commands.UFCP_DVR, -1, true)
...
dev:listen_command(device_commands.UFCP_IDNT)
dev:listen_command(device_commands.UFCP_XPDR_POWER)
...
function SetCommand(command,value)
    ...
    if command == device_commands.UFCP_XPDR_POWER then
        xpdr_set_power(value > 0.5)
        return
    elseif command == device_commands.UFCP_DVR then
        DVR_SWITCH_STATE:set(value)
    ...
    elseif command == device_commands.UFCP_A_A and value == 1 then
        set_avionics_master_mode(AVIONICS_MASTER_MODE_ID.DGFT_S)
    elseif command == device_commands.UFCP_NAV and value == 1 then
        set_avionics_master_mode(AVIONICS_MASTER_MODE_ID.NAV)
    elseif command == device_commands.UFCP_IDNT and value == 1 then
        xpdr_ident()
    ...
    elseif command == device_commands.UFCP_DVR then
        -- [Fase 5.2] cmfd:SetCommand agora chega ate o handler do DVR
        -- por causa do forwarding adicionado em cmfds.lua. Continuamos
        -- mantendo o DVR_SWITCH_STATE aqui (param handle compartilhado
        -- entre UFCP e CMFD), pois ele tambem alimenta indicadores.
        cmfd:SetCommand(command, value)
    end
    ...
    elseif ufcp_sel_format == UFCP_FORMAT_IDS.MANR then SetCommandManr(command, value)
    end
